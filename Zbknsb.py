    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                nadya.blockContact(op.param1) #, "Halo {} terimakasih telah menambahkan saya sebagai teman :D".format(str(nadya.getContact(op.param1).displayName)))
        if op.type == 13:
