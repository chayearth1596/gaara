...
RfuBot=[lineMID]
Family=["ucccca2ada2b522c6d59e6640f29aafd0",lineMID]
admin=['ucccca2ada2b522c6d59e6640f29aafd0',lineMID]
...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย ✨Ձัधနุ่थ సန้ণ७Ҩथี้✨ ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY:
╔══════════════┓
╠  ✨Ձัधနุ่थ సန้ণ७Ҩथี้✨
╚══════════════┛""",
...
#==============================================================================#
                    ...
                    line.sendContact(to, "ucccca2ada2b522c6d59e6640f29aafd0")
...
#==============================================================================#
                ...
                elif msg.text.lower().startswith("pt "):
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                ...
                elif msg.text.lower().startswith("vdo "):
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                        ...
                        for ls in lists:
                            ...
                            line.sendImageWithURL(msg.to, str(path))
                elif msg.text.lower().startswith("st "):
                    if line != None:
                        if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                            names = re.findall(r'@(\w+)', text)
                            mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                            ...
                            for ls in lists:
                                ...
                                line.sendImageWithURL(msg.to, str(path))
#==========================================                            
                elif msg.text.lower().startswith("pfl "):
                ...
                elif msg.text in ["allprotect on","zbkn"]:
                ...
                elif msg.text in ["allprotect off","zbkf"]:
                ...
                elif msg.text in ["Allmsg on","msgn"]:
                        settings["Wc"] = True
                        settings["Lv"] = True
                        settings["Nk"] = True
                        settings["autoRead"] = True
                ...
                elif msg.text in ["Allmsg off",".msgf"]:
                        settings["Wc"] = False
                        settings["Lv"] = False
                        settings["Nk"] = False
                        settings["autoRead"] = True
  ...
  #                  spl = msg.text.split("รับแก้ไฟล์+เพิ่มไฟล์+แก้ภาษา\n💝ราคาดูที่หน้างาน💝\n👉มีบริการให้เช่าบอทSAMURAI\nราคา300บาทต่อเดือน💖\n#เพิ่มคิกเกอร์ตัวละ100👌\n🎀สนใจรีบทัก..บอทpython3ฟังชั่นล้นหลาม🎁กำลังรอให้คุณเป็นเจ้าของ\n(ผมจะอยู่ที่ห้องนี้แค่15นาทีนะจ๊ะ)\nselfbot by:\n╔══════════════┓\n╠™❍✯͜͡RED™SAMURAI✯͜͡❂➣ \n╚══════════════┛")
     #               if spl[len(spl)-1] == "":
      #                  line.sendText(msg.to,"กดที่นี่เพื่อเขย่าข้อความด้านบน:\nline://nv/chatMsg?chatId="+msg.to+"&messageId="+msg.id)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("✨Ձัधနุ่थ సန้ণ७Ҩथี้✨",mi_d)
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"✨Ձัधနุ่थ సန้ণ७Ҩथี้✨")
                           line.sendText(g.mid,"✨Ձัधနุ่थ సန้ণ७Ҩथี้✨")
                           line.sendText(g.mid,"✨Ձัधနุ่थ సန้ণ७Ҩथี้✨")
                           line.sendText(g.mid,"✨Ձัधနุ่थ సန้ণ७Ҩथี้✨")
                           line.sendText(g.mid,"✨Ձัधနุ่थ సန้ণ७Ҩथี้✨")
                        ...
                        line.createGroup("✨Ձัधနุ่थ సန้ণ७Ҩथี้✨",[key])
                        line.sendText(msg,to,"❋ทำการรัน สำเร็จ❋")
                ...
                elif "zbkngar" in msg.text.lower():
                    if msg.toType == 2:
                        prov = eval(msg.contentMetadata["MENTION"])["MENTIONEES"]
                        allmid = []
                        for i in range(len(prov)):
                ...
                elif "mn " in msg.text.lower():
                    spl = re.split("mn ",msg.text,flags=re.IGNORECASE)
                    if spl[0] == "":
...
#===================================================================#              
                    ...
                    if receiver in read['readPoint']:
                        ...
                        line.sendMessage(receiver,"สั่ง (จับ) แล้วสั่ง (อ่าน) \n(^人^) ")                
#==============================================================================#
#=============================================#                    
...
#==============================================================================#
                ...
                elif "การ์ตูน " in msg.text.lower():
                    separate = msg.text.split(" ")
                    search = msg.text.replace(separate[0] + " ","")
                    with requests.session() as web:
                        web.headers["User-Agent"] = random.choice(settings["userAgent"])
                  ...
                  if msg._from in admin:
                     spl = msg.text.replace('Add:','')
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "❋ตั้งข้อความเรืยบร้อย❋")
                     else:
                         settings["message"] = spl
                         line.sendMessage(msg.to, "❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
                         
                elif 'Comn:' in msg.text:
                  if msg._from in admin:
                     spl = msg.text.replace('Comn:','')
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "❋ตั้งข้อความเรืยบร้อย❋")
                     else:
                         settings["comment"] = spl
                         line.sendMessage(msg.to, "❋ตั้งข้อความคอมเม้นแล้ว ❋\n\n{}".format(str(spl))) 
                    
                elif 'Rpt:' in msg.text:
                  if msg._from in admin:
                     spl = msg.text.replace('Rpt:','')
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "❋ตั้งข้อความเรืยบร้อย❋")
                     else:
                         settings["Respontag"] = spl
                         line.sendMessage(msg.to, "❋ตั้งข้อความตอบแทคแล้ว❋\n\n{}".format(str(spl)))
                         
                elif 'Zzz:' in msg.text:
                  if msg._from in admin:
                     spl = msg.text.replace('Zzz:','')
                     if spl in [""," ","\n",None]:
...
#=============COMMAND KICKER===========================#
                ...
                elif "บรรเทิง" in msg.text:
                	if msg.toType == 2:
                         _name = msg.text.replace("บรรเทิง","")
...
#==============FINNISHING PROTECT========================#
                ...
                elif "ดำหมด" in msg.text:
                  if msg._from in Family:
                      if msg.toType == 2:
                           print ("All Banlist")
                           _name = msg.text.replace("ดำหมด","")
                           gs = line.getGroup(msg.to)
                       ...
                       for target in targets:
                           try:
                               ...
                               f=codecs.open('st2__b.json','w','utf-8')
                               json.dump(settings["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                               line.sendMessage(msg.to,"❋ทำการติดดำสำเร็จ❋")
                               print ("Banned User")
                           except:
                               line.sendMessage(msg.to,"ผิดพลาด")
                       ...
                       for target in targets:
                           try:
                               ...
                               f=codecs.open('st2__b.json','w','utf-8')
                               json.dump(settings["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                               line.sendMessage(msg.to,"ทำการล้างดำสำเร็จ❋")
                               print ("Unbanned User")
                           except:
                               line.sendMessage(msg.to,"ผิดพลาด")
