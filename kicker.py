...
PRANK = [pb1,pb2,sb] #pb3,pb4,pb5,pb6,pb7,pb8,pb9,pb10,sb]
...
settings={
    ...
    "prankRespon": True,
    "prankcontact":False,
    "message": "THANKS FOR ADD ME\nCREATOR BY\n─┅═ই✯͜͡რန:Ωูढℓທພ௮່მ‮─┅═ই✯͜͡",
    "prankTL":False,
    "prankAdd":False,
    "keyCommand": ".",
    "server": "ucccca2ada2b522c6d59e6640f29aafd0",
    "conection":True,
    "setKey": False,
    "prankJoin":False,
    'prank_name': {},
                              ...
                              if acil == 'on':
                                  ...
                                  sb.sendMessage(msg.to, msgs)
                                    ...
                                    if msg.to in Prankinvite:
                                         ...
                                         msgs = "sudah tidak aktif dalam grup ini"
                                    sb.sendMessage(msg.to, msgs)
                        elif 'member:' in msg.text:
                              acil = msg.text.replace('member:','')
                              if acil == 'on':
