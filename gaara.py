...
line = LINE()
#line = LINE("เมล","พาส")
#line = LINE('EALlZJsFLgreJFLpqSR9.TfVZQibqmlNxXyD/JKbusq.EAYZoMmQKynJaxuOUtbA+o7VJqBxQbNbKkY3y85lq10=')
...
RfuBot=[lineMID]
Family=["ub45bf3a8805030b9d7c5877e8e405449","ucccca2ada2b522c6d59e6640f29aafd0",lineMID]
admin=['ub45bf3a8805030b9d7c5877e8e405449','ucccca2ada2b522c6d59e6640f29aafd0',lineMID]
...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย ┄┅☪➴͜͡✯Ǥααℓα➴͜͡✯☪┅┄ ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY:
╔══════════════┓
 ┄┅☪➴͜͡✯Ǥααℓα➴͜͡✯☪┅┄
╚══════════════┛""",
...
fukgerMessage = ["ควย","หี","แตด","เย็ดแม่","เย็ดเข้","ควย","สัส","เหี้ย","ไอ้เหี้ย","พ่อมึงตาย","ไอ้เลว","ระยำ","ชาติหมา","หน้าหี","เซลกาก","พ่องตาย","ส้นตีน","แม่มึงอ่ะ","แม่มึงดิ","พ่อมึงดิ"]
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "┄┅☪➴͜͡✯Ǥααℓα➴͜͡✯☪┅┄")
...
#==============================================================================#
                    ...
                    msg.contentType = 13
                    line.sendMessage(to, "คนสร้างบอทตัวนี้.. (｡◕‿◕｡)")
                    line.sendContact(to, "ucccca2ada2b522c6d59e6640f29aafd0")                        
                    line.sendMessage(to, "ท่านผู้นี้เป็นคนโมดีฟายบอทนี้จร้าา")
#                    line.sendContact(to, "ua54e1e15a35d24c6fbbf9349d93999e3")
#                    line.sendContact(to, "ucf8ff4fd7eb0df308881c26f459e26fe")
#==============================================================================#
...
#                        line.sendText(msg.to,"กดที่นี่เพื่อเขย่าข้อความด้านบน:\nline://nv/chatMsg?chatId="+msg.to+"&messageId="+msg.id)
                    ...
                    for g in gs.members:
                        ...
                        line.createGroup("┄┅☪➴͜͡✯Ǥααℓα➴͜͡✯☪┅┄",[key])
                        line.sendText(msg,to,"❋ทำการรัน สำเร็จ❋")
...
#==============================================================================#
                    ...
                    for k in range(0, len(bulan)):
                        if bln == str(k): bln = bulan[k-1]
                    readTime = "🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸" + "\n\n🍥 วันนี้ " + hasil + "\n🍥 เป็นวันที่ " + timeNow.strftime('%d') + " เดือน " + bln + " ปี " + timeNow.strftime('%Y')  + "\n🍥 ขณะนี้เวลา : " + timeNow.strftime('%H:%M:%S') + "\n\n" + "🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸" + "\n\nBy. ┄┅☪➴͜͡✯Ǥααℓα➴͜͡✯☪┅┄"
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "┄┅☪➴͜͡✯Ǥααℓα➴͜͡✯☪┅┄\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
                	...
                	if msg.toType == 2:
                         ...
                         if matched_list == []:
                             ...
                             for jj in matched_list:
                                 try:
                                     line.kickoutFromGroup(receiver,[jj])
                                     print((receiver,[jj]))
                                 except:
        ...
        if op.type == 19:
            if op.param2 not in Family:
                if op.param2 in Family:
                    ...
                    settings ["blacklist"][op.param2] = True
                    line.kickoutFromGroup(op.param1,[op.param2])
                    line.inviteIntoGroup(op.param1,[op.param2])
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
            	if msg.text in ["กำ","กำนะ"]:
                    line.sendText(msg.to,"มันเป็นกรรม อะเฮ้ยย..")
            if settings ["Api"] == True:
                if msg.text in ["ออน"]:
                    line.sendText(msg.to,"มึงเก็บเลเวลรึไงเนี่ย..")
            if settings ["Api"] == True:
                if msg.text in ["5555","55555","55+","555+","5555+","ขำ",".ขำ"]:
                    line.sendText(msg.to,"ฮาขนาดนั้นเลย..")
            if settings ["Api"] == True:
                if msg.text in ["Sp","Speed"]:
                	line.sendText(msg.to,"โห..!! แรงสัสๆ")
        if op.type in [25,26]:
            msg = op.message
